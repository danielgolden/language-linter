...
function Suggestion(props) {
  ...
  const renderSummary = () => {
    const renderSummaryCurrent = () => {
      const summaryCurrentOnClick =
        summaryType() === "removal" ? () => handleRemovalClick() : null;
      ...
      switch (suggestion.source) {
        case "retext-passive":
          ...
          return (
            <>
              The passive voice: {` `}
              <span className="basic-summary-example">
    ...
    switch (suggestion.source) {
      ...
      case "retext-contractions":
        if (suggestion.ruleId === "missing-smart-apostrophe") {
          return (
            <>
              It appears your missing an apostrophe in{" "}
              {highlightText(suggestion.actual)}.
            </>
          );
          ...
          return (
            <>
              ...
              {highlightText(suggestion.actual)}. Consider changing it to a
              smart apostrophe like this: {highlightText(suggestion.expected)}.
            </>
          );
        } else {
      ...
      case "retext-readability":
        ...
        return (
          <>
            We're {Math.round(suggestion.confidence * 100)}% sure the sentence
            beginning with {highlightText(readabilityCuplrit())}... is difficult
            to read. Consider rewriting it to make it easier to read.
          </>
        );
      case "retext-use-contractions":
        return (
  ...
  const renderSuggestionSecondaryActionCTA = () => {
    ...
    switch (suggestion.source) {
      ...
      case "retext-indefinite-article":
        learnMoreLink =
          "https://www.ef.edu/english-resources/english-grammar/indefinite-articles/";
        break;
      case "retext-equality":
        learnMoreLink =
      ...
      case "retext-readability":
        learnMoreLink =
          "https://www.dorisandbertie.com/goodcopybadcopy/2017/02/14/sentence-structure-how-to-make-your-sentences-much-easier-to-read";
        break;
      case "retext-passive":
        learnMoreLink =
      ...
      case "retext-use-contractions":
        learnMoreLink =
          "https://one-core.datanerd.us/foundation/design/writing/contractions/";
        break;
      case "retext-no-emojis":
        learnMoreLink =
      ...
      default:
        learnMoreLink =
          "https://one-core.datanerd.us/nr1-product/design/writing";
    }
  ...
  const handleRemovalClick = () => {
    ...
    const lastCharOfTextBeforeOffender = textBeforeOffender.substring(
      textBeforeOffender.length - 1,
      textBeforeOffender.length
    );
    ...
    if (lastCharOfTextAfterOffender === " ") {
      ...
      textBeforeOffender = textBeforeOffender.substring(
        0,
        textBeforeOffender.length - 1
      );
    }
  ...
  return (
    ...
    >
      ...
      <div className="suggestions-ctas">
        ...
        <button
          className={`suggestion-cta-secondary suggestion-cta-icon-only ${
            deleteIsHovered ? "delete-is-hovered" : ""
          }`}
